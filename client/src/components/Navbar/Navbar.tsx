        ...
        <header className="w-[85%] mx-auto my-8">
            <nav>
                <div className="flex w-full justify-between items-center">
                    <div className="flex border-primary border-[2px] gap-1 items-center bg- backdrop-blur-md rounded-xl py-2 px-3">
                        <TbBrandBooking size={45} className="text-primary"/>
                        <h1 className="text-primary font-semibold text-xl">BookWithMe</h1>
                    </div>
                    <div
                        className="flex items-center py-4 mx-auto px-3 gap-4 border-[1px] border-gray-400 shadow-md shadow-gray-300 rounded-xl">
